...
from fastapi.responses import FileResponse  # Add this at the top
...
async def generate_video(
    ...
    process = subprocess.run(command, cwd=VACE_WORK_DIR, stdout=sys.stdout, stderr=sys.stderr, text=True)
